...
--
-- Data for Name: employees; Type: TABLE DATA; Schema: evaluation; Owner: postgres
--

COPY evaluation.employees (id, name, email, password, is_admin, permission, failed_count, is_locked, locked_at, role) FROM stdin;
\.


--
-- Data for Name: evaluation_periods; Type: TABLE DATA; Schema: evaluation; Owner: postgres
--

COPY evaluation.evaluation_periods (id, name, start_date, end_date, self_eval_due, peer_eval_due, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: evaluations; Type: TABLE DATA; Schema: evaluation; Owner: postgres
--

COPY evaluation.evaluations (id, evaluator_id, target_id, skill_score, business_score, team_score, comment, created_at, updated_at, phase_id) FROM stdin;
\.


--
-- Data for Name: password_reset_tokens; Type: TABLE DATA; Schema: evaluation; Owner: postgres
--

COPY evaluation.password_reset_tokens (token, email, expires_at, used, created_at) FROM stdin;
\.


--
-- Data for Name: phases; Type: TABLE DATA; Schema: evaluation; Owner: postgres
--

COPY evaluation.phases (id, name, start_date, end_date, self_eval_due, peer_eval_due, created_at, updated_at, phase_number) FROM stdin;
\.


--
-- Name: employees_id_seq; Type: SEQUENCE SET; Schema: evaluation; Owner: postgres
--

SELECT pg_catalog.setval('evaluation.employees_id_seq', 1, false);


--
-- Name: evaluation_periods_id_seq; Type: SEQUENCE SET; Schema: evaluation; Owner: postgres
--

SELECT pg_catalog.setval('evaluation.evaluation_periods_id_seq', 1, false);


--
-- Name: evaluations_id_seq; Type: SEQUENCE SET; Schema: evaluation; Owner: postgres
--

SELECT pg_catalog.setval('evaluation.evaluations_id_seq', 1, false);


--
-- Name: phases_id_seq; Type: SEQUENCE SET; Schema: evaluation; Owner: postgres
--

SELECT pg_catalog.setval('evaluation.phases_id_seq', 1, false);
