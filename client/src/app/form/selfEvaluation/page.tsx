...
// useEffect, useRouter をインポートに追加します
import { useSearchParams, useRouter } from 'next/navigation'; // 変更点1: useRouter を追加
...
export default function SelfEvaluationPage() {
  const router = useRouter(); // 変更点2: useRouterを呼び出す行を追加
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      router.push('/submitted'); // 変更点3: 画面遷移の行を追加
